...
function Disclaimer() {
  return (
    <div id="disclaimer" className="disclaimer-main">
      <h2>
        <b>DISCLAIMER</b>
      </h2>
      ...
      <p>
        The information provided by <b>Silicon Loops</b> (“Company”, “we”,
        “our”, “us”) on <b>https://silicon-loops.web.app/</b> (the “Site”) is
      ...
      <p>
        Content published on https://silicon-loops.web.app/ is intended to be
        used and must be used for informational purposes only. It is very
        ...
        advice from a professional or independently research and verify any
        information that you find on our Website and wish to rely upon.{" "}
      </p>
      <p>
      ...
      <p>
        ...
        contained in this site has been obtained from reliable sources, Silicon
        Loops is not responsible for any errors or omissions or for the results
      ...
      <p>
        In no event will Silicon Loops, its related partnerships or
      ...
      <p>
        ...
        https://silicon-loops.web.app/ are the trademarks and logos of their
        respective owners. Any inclusion of such trademarks or logos does not
        imply or constitute any approval, endorsement or sponsorship of Silicon
        Loops by such owners.
      </p>
      <br />
      <p>
        <b>CONTACT US</b>
