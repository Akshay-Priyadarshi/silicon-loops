...
function PrivacyPolicy() {
  return (
    <div id="privacy-policy" className="privacy-policy-main">
      <h2>
        <b>PRIVACY POLICY</b>
      </h2>
      <p>Effective date: 2020-12-06</p>
      <br />
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b> Silicon Loops</b>.
      </p>
      <p>
        <b>Silicon Loops</b> (“us”, “we”, or “our”) operates{" "}
        <b>https://silicon-loops.web.app/</b> (hereinafter referred to as{" "}
        <b>“Service”</b>).
      </p>
      <p>
        Our Privacy Policy governs your visit to{" "}
        <b>https://silicon-loops.web.app/</b>, and explains how we collect,
      ...
      <p>
        <b>SERVICE</b> means the https://silicon-loops.web.app/ website operated
        by Silicon Loops.
      </p>
      <p>
      ...
      <p>Silicon Loops uses the collected data for various purposes:</p>
      ...
      <p>
        Silicon Loops will take all the steps reasonably necessary to ensure
      ...
      <p>
        ...
        at <b>akshayp1904@outlook.com</b>.
      </p>
      ...
      <p>
        ...
        please send your request(s) by email: <b>akshayp1904@outlook.com</b>.
      </p>
      <p>
      ...
      <p>
        ...
        by email: <b>akshayp1904@outlook.com</b>.
      </p>
    </div>
  );
}
