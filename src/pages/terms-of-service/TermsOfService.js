...
function TermsOfService() {
  return (
    <div id="terms-of-service" className="terms-of-service-main">
      <h2>
        <b>TERMS AND CONDITIONS</b>
      </h2>
      <p>Last updated: 2020-12-06</p>
      <br />
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b>Silicon Loops</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>https://silicon-loops.web.app/</b> (together
        or individually “Service”) operated by <b>Silicon Loops</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>akshayp1904@outlook.com</b> so we can try to find a solution. These
      ...
      <p>
        Silicon Loops has the right but not the obligation to monitor and edit
        all Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property
        of Silicon Loops or used with permission. You may not distribute,
      ...
      <p>
        ...
        Silicon Loops and its licensors. Service is protected by copyright,
        ...
        written consent of Silicon Loops.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        to akshayp1904@outlook.com, with the subject line: “Copyright
      ...
      <p>
        You may provide us either directly at akshayp1904@outlook.com or via
      ...
      <p>
        ...
        are not owned or controlled by Silicon Loops.
      </p>
      <p>
        Silicon Loops has no control over, and assumes no responsibility for the
      ...
      <p>
        ...
        email: <b>akshayp1904@outlook.com</b>.
      </p>
    </div>
  );
}
